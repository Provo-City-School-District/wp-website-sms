...
<head>
	<!-- Google tag (gtag.js) -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-EL8LKJ5C22"></script>
	<script>
...
<body>
	...
	<header id="mainHeader">
		<a href="<?php bloginfo('siteurl'); ?>"><img src="<?php echo get_stylesheet_directory_uri() . '/assets/images/header-logo.png'; ?>" alt="Shoreline Middle School Logo" id="siteLogo" />
			<h1>Shoreline Middle School</h1>
		</a>
		<aside>
			...
			<ul class="contactinfo" itemscope itemtype="https://schema.org/PostalAddress">
				<li><span itemprop="streetAddress">1201 West 890 South</span><span itemprop="addressLocality"> Provo</span>, <span itemprop="addressRegion">Utah</span> <span itemprop="postalCode">84601</span><span class="phone" itemprop="telephone"> Phone: (801) 374-4980</span><span class="fax" itemprop="faxNumber"> Fax: (801) 374-4884</span></li>
			</ul>
